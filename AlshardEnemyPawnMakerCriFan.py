...
class GuardianData():
    ...
    def output_pawn(self, text_data):
        ...
        commandtext = "//アクション\nムーブ:\nマイナー:\nメジャー:\n//リソース\n" + \
                                       ...
                                       "//攻撃、+0欄に修正を記入\nAL+{命中値}+0[{クリティカル値},{ファンブル値}]" + \
                                       "近・命中\nAL+{魔導値}+0　遠・魔導[{クリティカル値},{ファンブル値}]\n"
        ...
        commandtext = (commandtext + "\n//能力値判定\nAL+{体力B}[{クリティカル値},{ファンブル値}]　体力判定\n" + \
                                     "AL+{反射B}[{クリティカル値},{ファンブル値}]　反射判定\n" + \
                                     "AL+{知覚B}[{クリティカル値},{ファンブル値}]　知覚判定\n" + \
                                     "AL+{理知B}[{クリティカル値},{ファンブル値}]　理知判定\n" + \
                                     "AL+{意志B}[{クリティカル値},{ファンブル値}]　意志判定\n" + \
                                     "AL+{幸運B}[{クリティカル値},{ファンブル値}]　幸運判定")
